    ...
    public partial class Mig_1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HesCodes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HesCodes_Accounts_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Accounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HesCodes_Accounts_AccountId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Neigborhood_District_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CityId = table.Column<int>(type: "int", nullable: false),
                    DistrictId = table.Column<int>(type: "int", nullable: false),
                    NeigborhoodId = table.Column<int>(type: "int", nullable: false),
                    PatientDensityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Address_Densities_PatientDensityId",
                        column: x => x.PatientDensityId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Address_Neigborhood_NeigborhoodId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Users_Densities_PatientDensityId",
                        column: x => x.PatientDensityId,
                        principalTable: "Densities",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Address_NeigborhoodId",
                table: "Address",
                column: "NeigborhoodId");

            migrationBuilder.CreateIndex(
                name: "IX_Address_PatientDensityId",
                table: "Address",
                column: "PatientDensityId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HesCodes_AccountId",
                table: "HesCodes",
                column: "AccountId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HesCodes_AccountId1",
                table: "HesCodes",
                column: "AccountId1");

            migrationBuilder.CreateIndex(
                name: "IX_Neigborhood_DistrictId",
                table: "Neigborhood",
                column: "DistrictId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Users_PatientDensityId",
                table: "Users",
                column: "PatientDensityId");
        }
